...
/**
 * The send contactus feature. It can be used to verify if the parameter that contain
 * recipient e-mail is configured.
 * 
 * @author Mykhaylo Boychuk (mykhaylo.boychuk at 4science.com)
 */
@Component
@AuthorizationFeatureDocumentation(name = CanSendContactusFeature.NAME,
    description = "It can be used to verify if the parameter that contain recipient e-mail is configured.")
public class CanSendContactusFeature implements AuthorizationFeature {

    public static final String NAME = "canSendContactus";
